...
import { Code, Database, Cloud, Server, Globe, Terminal, Gauge, Sparkles, Rocket, Coffee, Brain, Lock, Laptop, Palette, Lightbulb, Heart, Star } from 'lucide-react';
...
const skillCategories = [
  {
    ...
    skills: [
      ...
      { name: 'Modern CSS & Tailwind', level: 90 }
    ]
  },
  {
        ...
        <div className="container-padding mx-auto relative">
          <div className="max-w-3xl mx-auto text-center animate-in">
            ...
            <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300">
              Full Stack Developer crafting scalable solutions and exceptional digital experiences
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-white dark:bg-gray-800 p-6 rounded-xl shadow-xl max-w-xs transform hover:scale-105 transition-transform duration-300">
                <div className="flex items-center gap-2 border-b border-gray-200 dark:border-gray-700 pb-2 mb-3">
                  ...
                  <span className="text-xs text-gray-500 dark:text-gray-400">developer.ts</span>
                </div>
                <div className="font-mono text-xs">
                  <p><span className="text-purple-500">const</span> <span className="text-blue-500">developer</span> = {`{`}</p>
                  <p className="pl-4"><span className="text-green-500">name</span>: <span className="text-orange-500">'Hitesh Parmar'</span>,</p>
                  <p className="pl-4"><span className="text-green-500">passion</span>: <span className="text-orange-500">'Building scalable solutions'</span></p>
                  <p>{`}`};</p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-6 relative">
                <div className="card p-6 transform hover:scale-105 transition-transform duration-300">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    My journey in tech began with a deep curiosity about how things work. From building simple websites to developing complex distributed systems, every step has been a learning experience.
                  </p>
                </div>
                ...
                <div className="card p-6 transform hover:scale-105 transition-transform duration-300">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    As technology evolved, so did my skills. I've embraced modern frameworks, cloud technologies, and best practices in software development, always staying at the forefront of innovation.
                  </p>
                </div>
                ...
                <div className="card p-6 transform hover:scale-105 transition-transform duration-300">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    Now, I specialize in building scalable web applications using modern technologies like React, Next.js, Go, and cloud services. I focus on creating solutions that make a real impact.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-16">
              ...
              <div className="timeline-item relative">
                ...
                <div className="card max-w-lg mx-auto">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    Leading the development of scalable web applications, focusing on microservices architecture and cloud infrastructure. Implementing advanced features and optimizing system performance.
                  </p>
                </div>
              </div>
              ...
              <div className="timeline-item relative">
                ...
                <div className="card max-w-lg mx-auto">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    Developed full-stack applications using React, Node.js, and AWS. Implemented CI/CD pipelines and containerized applications using Docker and Kubernetes.
                  </p>
                </div>
              </div>
              ...
              <div className="timeline-item relative">
                ...
                <div className="card max-w-lg mx-auto">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    Specialized in database design and API development. Built scalable backend services and optimized database performance for high-traffic applications.
                  </p>
                </div>
              </div>
              ...
              <div className="timeline-item relative">
                ...
                <div className="card max-w-lg mx-auto">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    Studied Computer Science with a focus on distributed systems and software engineering. Completed a thesis on scalable microservices architecture.
                  </p>
                </div>
              </div>
            </div>
            ...
            {[
              {
                ...
                description: 'I believe in writing clean, maintainable code and following best practices. Every line of code should be purposeful and efficient.',
                icon: <Terminal className="h-8 w-8" />
              },
              {
                title: 'Continuous Learning',
                description: 'Technology evolves rapidly, and I am committed to staying current with the latest tools and practices in software development.',
                icon: <Brain className="h-8 w-8" />
              },
              {
                title: 'Problem Solving',
                description: 'I approach each challenge methodically, breaking down complex problems into manageable solutions.',
        ...
        <div className="container-padding mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
              While coding is my profession, I believe in maintaining a rich and balanced life that fuels creativity and innovation.
            </p>
          </div>
              ...
              <div className="card p-6 transform hover:scale-105 transition-all duration-300 cursor-pointer group">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 dark:text-gray-300">
                      Actively contribute to open-source projects and share knowledge through technical articles and documentation. I believe in giving back to the developer community.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="card p-6 transform hover:scale-105 transition-all duration-300 cursor-pointer group">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 dark:text-gray-300">
                      Regularly attend tech conferences, workshops, and online courses to stay updated with the latest technologies and best practices in software development.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="card p-6 transform hover:scale-105 transition-all duration-300 cursor-pointer group">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 dark:text-gray-300">
                      Passionate about mentoring junior developers and organizing local tech meetups. Building a supportive tech community is close to my heart.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4 relative">
              <div className="relative group overflow-hidden rounded-lg aspect-[4/3]">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
                  <p className="text-white text-sm">Speaking at Tech Conference 2023</p>
                </div>
              </div>
              ...
              <div className="relative group overflow-hidden rounded-lg aspect-[4/3]">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
                  <p className="text-white text-sm">Weekend Adventures</p>
                </div>
              </div>
